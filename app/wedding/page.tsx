					...
					<BlushMediumBox>
						...
						<div className="text-sage-darker space-y-1">
							<p><strong>Plats:</strong> Tävelsås bygdegård - <a
								...
								className="font-medium text-sage-darker underline decoration-sage-darker/40 underline-offset-2 hover:decoration-sage-darker">Vägbeskrivning</a>
							</p>
							<p><strong>Datum & Tid:</strong> Buss avgår till vigselplats 14:00 den 15 augusti 2026</p>
						</div>

						<p className="text-sage-dark mt-2 text-sm">
							För mer information om schemat <Link href="/wedding/schedule"
						...
						<div className="text-center space-y-2">
							...
							<p className="text-sage-darker"><strong>Viktor Ferm:</strong> <a href="tel:+46708261181"
							                                                                 className="font-medium text-sage-darker underline decoration-sage-darker/40 underline-offset-2 hover:decoration-sage-darker">070-826
								11 81</a></p>
							<p className="text-sage-darker"><strong>Matilda Rasmusson:</strong> <a
								href="tel:+46793343021"
								className="font-medium text-sage-darker underline decoration-sage-darker/40 underline-offset-2 hover:decoration-sage-darker">079-334
								30 21</a></p>
							<p className="text-sage-darker italic"><a href="mailto:toastmasters.berlind@gmail.com"
							                                          className="font-medium text-sage-darker underline decoration-sage-darker/40 underline-offset-2 hover:decoration-sage-darker">toastmasters.berlind@gmail.com</a>
							</p>
						</div>
